namespace :db do
  ...
  task populate: :environment do
    ...
    p1 = Promotion.create!(kind:'Nx1', quantity: 2, discount: 50.0, name: "Promotion 2 x 1")
    p2 = Promotion.create!(kind:'%xN', quantity: 3, discount: 10.0, name: "You have 10 % from 3 units onwards")
